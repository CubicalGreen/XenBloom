...
class AddDevice {
  Future<bool> addDeviceInBackend(
      String deviceName, String deviceSettings) async {
  ...
  Future<void> addDevice(String? deviceId, String device_name,
      String device_settings, String uid) async {
    final url = Uri.parse("https://adddevice-ta72nhrlya-uc.a.run.app");

    final payload = {
      "deviceId": deviceId,
      "device": {"name": device_name, "settings": device_settings},
      "uid": uid
    };
